      ...
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Sahil Gangwani</h3>
            <p className="text-base leading-7 text-about_me_green">Full-stack Web Developer</p>
            <p className="mt-4 text-lg text-gray-500">I&apos;m a software engineer with a strong problem-solving mindset and experience working with diverse technologies.</p>
            <p className="mt-4 text-lg text-gray-500"> Adaptable and committed to taking on new challenges, always focused on delivering high-quality solutions
 while continuously refining skills and expertise.</p>
          </div>
